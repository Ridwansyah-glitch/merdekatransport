  ...
  <body>
    ...
    <!--documents-->
        <div class="row row-offcanvas row-offcanvas-left">
		  ...
		  <center>
                    <h2 class="content-row-title">EDIT DATA TARIF ANGKUT BARANG</h2><hr>
<?php
mysql_connect("localhost","root","");

mysql_select_db("db_merdeka");
$ambil=mysql_query("select * from tarif where id_tarif='$_GET[id]'");
$data=mysql_fetch_array($ambil);
?>
<form method="post" action="proses_edit_tarif.php">
<table border=0>
<input type="hidden" name="id_tarif" value="<?php echo $data['id_tarif'];?>">
<tr><td>Kota Asal</td><td>&nbsp;&nbsp;: &nbsp;&nbsp;</td><td><input type="text" name="asal" maxlength=20 size=20 value="<?php echo $data['kota_asal'];?>" required/></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>Kota Tujuan</td><td>&nbsp;&nbsp;: &nbsp;&nbsp;</td><td><input type="text" name="tujuan" maxlength=20 size=20 value="<?php echo $data['kota_tujuan'];?>" required/></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>Kapasitas Maximal</td><td>&nbsp;&nbsp;: &nbsp;&nbsp;</td><td><input type="text" name="max" maxlength=10 size=10 value="<?php echo $data['max_kapasitas'];?>" required/> Kilogram</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>Harga Angkut</td><td>&nbsp;&nbsp;: &nbsp;&nbsp;</td><td><input type="text" name="harga" maxlength=10 size=10 value="<?php echo $data['harga'];?>" required/> Rupiah</td></tr>
<tr><td>&nbsp;</td></tr>
</table>
<br>
<input type="submit" value="Update Data">&nbsp;&nbsp;<a href="data_tarif.php"><input type="button" value="Kembali"></a>
</form>
        </div><!-- content -->
      </div>
    </div>
