            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="content-row">
                  ...
                  <div class="col-md-12">
                    <h2 id="tables" class="page-header">Data Tarif Angkut Barang</h2>
                    <div class="bs-example">
<img src="icon/add.png" width=20px>&nbsp;<a href="input_tarif.php">Tambah Data Baru</a>
<br><br>
<?php
...
<td><?php echo $data['max_kapasitas'];?> Kilogram</td>
<td>
<?php
$jumlah=$data['harga'];
$jumlah_desimal="2";
...
<td><center><a href="edit_tarif.php?id=<?php echo $data['id_tarif'];?>" title="Edit Data"><img src="icon/edit.png" height=20px></a>&nbsp;&nbsp;<a href="delete_tarif.php?id=<?php echo $data['id_tarif'];?>"  onClick="return confirm('Apakah anda yakin akan menghapus data ini?')" title="Delete Data"><img src="icon/delete.png" height=20px></a></td>
</tr>
<?php 
$no++;
}
