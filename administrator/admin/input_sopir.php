  ...
  <body>
    ...
    <!--documents-->
        <div class="row row-offcanvas row-offcanvas-left">
		  ...
		  <center>
                    <h2 class="content-row-title">INPUT DATA SOPIR ANGKUT BARANG</h2><hr>
<form method="post" action="proses_sopir.php">
<table border=0>
<tr><td>Nama Sopir</td><td>&nbsp;&nbsp;: &nbsp;&nbsp;</td><td><input type="text" name="nama" maxlength=30 size=30 required/></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>Alamat</td><td>&nbsp;&nbsp;: &nbsp;&nbsp;</td><td><textarea name="alamat" cols=30 rows=5 required/></textarea></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>Nomor Telepon</td><td>&nbsp;&nbsp;: &nbsp;&nbsp;</td><td><input type="text" name="no_telepon" maxlength=15 size=15 required/></td></tr>
<tr><td>&nbsp;</td></tr>
</table>
<br>
<input type="submit" value="Simpan">&nbsp;&nbsp;<a href="data_sopir.php"><input type="button" value="Kembali"></a>
</form>
        </div><!-- content -->
      </div>
    </div>
