            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="content-row">
                  ...
                  <div class="col-md-12">
                    <h2 id="tables" class="page-header">Data Pelanggan</h2>
...
<td><center><a href="konfirmasi.php?id=<?php echo $data['id_pelanggan'];?>" title="Konfirmasi"><input type="button" value="Konfirmasi Pendaftaran"></a></td>
<?php
} else {
?>
